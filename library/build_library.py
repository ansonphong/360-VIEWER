            ...
            if image_files:
                ...
                for image_file in image_files:
                    ...
                    file_info = {
                        ...
                        'path': file_path,
                        'thumbnail': f"_BUILD/{thumbnail_filename}",
                        'Q100': f"_BUILD/{q100_filename}",
                        'Q75': f"_BUILD/{q75_filename}",
                        'Q50': f"_BUILD/{q50_filename}"
                    }
...
def generate_thumbnail_path(root_dir, file_path):
    ...
    full_path = os.path.join(root_dir, '_BUILD', '_thumbnails', thumbnail_name).replace(os.sep, '/')
...
def generate_jpg_path(root_dir, file_path, quality):
    ...
    full_path = os.path.join(root_dir, '_BUILD', f'_{quality}', jpg_name).replace(os.sep, '/')
